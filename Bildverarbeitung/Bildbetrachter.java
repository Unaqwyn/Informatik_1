 ...
 * anderen Komponenten.
 * 
 * @author Carlo Bach (auf Basis von Michael Kölling und David J Barnes)
 * @version 1.1
...
public class Bildbetrachter extends JFrame
{
    ...
    private void toolbarErzeugen(JFrame fenster)
    {
        ...
        b.addActionListener(e -> { 
                    ...
                    //double[][] sobelfilter = {{0.11111,0.11111,0.11111},{0.1111,0.11111,0.11111},{0.11111,0.1111,0.11111}};
    ...
    {
        aktuellesBild.printHistogramm();
        System.out.println();
        System.out.println(""+aktuellesBild.getBrightest()+" "+aktuellesBild.getDarkest());
        System.out.println();
    }
}
